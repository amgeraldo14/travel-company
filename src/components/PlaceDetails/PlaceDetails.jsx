    ...
    <Card elevation={6}>
      ...
      <CardContent>
        ...
        {place?.awards?.map((award, i) => (
          <Box display="flex" justifyContent="space-between" alignItems="center" my={1} key={i}>
        ...
        <CardActions>
          ...
          <Button size="small" color="primary" onClick={() => window.open(place.write_review, '_blank')}>Write Review</Button>
        </CardActions>
      </CardContent>
    </Card>
  )
